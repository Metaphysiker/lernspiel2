class CoursesController < ApplicationController
  ...
  def ethics
    ...
    @whatareyou = [
        ...
        ["Die örtliche Feuerwehr ist seit Jahren unterbezahlt und leidet an Personalmangel. Die Behörden weigern sich vehement, in die Feuerwehr zu investieren. Würdest du ein unbewohntes Haus anzünden, um die Behörden zum Umdenken zu zwingen?", "Ja, ich würde deswegen ein Haus anzünden.", "Nein, ich würde deswegen kein Haus anzünden.", [0,1]],
